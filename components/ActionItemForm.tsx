...
import { ActionItem, ActionItemStatus, User } from '../types';
...
const ActionItemForm: React.FC<ActionItemFormProps> = ({ onClose, onSave, initialData, participants }) => {
    ...
    <form onSubmit={handleSubmit}>
      <div className="space-y-4">
        ...
        <div>
          ...
          <select id="status" value={status} onChange={e => setStatus(e.target.value as ActionItemStatus)} className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-gray-700 dark:border-gray-600" required>
