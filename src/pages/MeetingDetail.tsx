        ...
        <div id="meeting-minutes-content" className="p-8">
            <div className="border-b dark:border-gray-700 pb-6 mb-6">
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
                    ...
                    <InfoItem icon={<CreatorIcon />} label="Host" value={meeting.createdBy.name} />
                </div>
            </div>
...
const CreatorIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" /></svg>;
